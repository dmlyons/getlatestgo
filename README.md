...
A CLI tool that looks up the latest Go release for your architecture, optionally downloads it with SHA256 verification, and can install it automatically.
...
| Flag | Description |
|------|-------------|
| `-execute` | Download the file and verify its SHA256 checksum |
